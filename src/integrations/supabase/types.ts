...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      participation_status: "registered" | "participated" | "winner" | "runner_up" | "disqualified";
      payment_status:
        | "pending"
        | "success"
        | "failed"
      ...
      subscription_status: "active" | "cancelled" | "expired" | "pending" | "paused";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      membership_type: ["monthly", "yearly", "lifetime"],
      participation_status: ["registered", "participated", "winner", "runner_up", "disqualified"],
      payment_status: ["pending", "success", "failed", "refunded", "refund_pending", "cancelled"],
      plan_status: ["active", "inactive"],
      subscription_status: ["active", "cancelled", "expired", "pending", "paused"],
    },
  },
