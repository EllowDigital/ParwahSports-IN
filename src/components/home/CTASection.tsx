  ...
  return (
    <section className="py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={victoryImage} alt="Athletes celebrating" className="w-full h-full object-cover" />
          ...
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-primary-foreground mb-5 leading-tight">
                Support Young Athletes — <span className="text-secondary">Transform Lives</span>
              </h2>

              <p className="text-lg lg:text-xl text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed">
                Your contribution can change the trajectory of a young athlete's life. Help us
                provide world-class training, equipment, and opportunities.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid sm:grid-cols-3 gap-4 lg:gap-6 mb-12">
            {actions.map((item, index) => (
              <ScrollReveal key={index} delay={150 + index * 80} animation="scale">
                <div
                  className={`rounded-2xl p-6 lg:p-8 text-center h-full transition-all duration-300 hover:-translate-y-1 ${
                    item.highlight
                ...
                >
                  <div
                    className={`w-14 h-14 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center mx-auto mb-5 ${
                      item.highlight ? "bg-secondary-foreground/20" : "bg-primary-foreground/10"
                    }`}
                  >
                    <item.icon
