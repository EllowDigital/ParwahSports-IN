...
const faqs = [
  {
    question: "What sports programs does Parwah Sports offer?",
    answer:
      "We offer comprehensive programs including athlete financial support, professional coaching & training, school collaborations, talent identification & development, and community engagement initiatives across multiple sports disciplines.",
  },
  {
    question: "Who can benefit from Parwah Sports programs?",
    answer:
      "Our programs are designed for young and underprivileged athletes across India, regardless of their background. We support athletes from grassroots level to national and international competitions.",
  },
  {
    question: "How does Parwah Sports identify talented athletes?",
    answer:
      "We use a systematic scouting and assessment process that includes talent trials, school partnerships, district-level tournaments, and referrals from coaches and community leaders to identify promising athletes.",
  },
  {
    question: "Does Parwah Sports provide financial assistance to athletes?",
    answer:
      "Yes, we provide scholarships, equipment funding, travel support for competitions, nutrition assistance, and other financial aid to athletes who demonstrate talent and commitment.",
  },
  {
    question: "How can schools partner with Parwah Sports?",
    answer:
      "Schools can partner with us through our School & Academy Collaboration program. We deploy trained coaches, develop structured sports curricula, and organize inter-school competitions. Contact us to learn more.",
  },
];
