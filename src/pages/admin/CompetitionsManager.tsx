  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <PageHeader
          title="Competitions"
          description="Manage sports competitions and events"
              ...
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-8 text-muted-foreground">
                    {searchTerm ? "No matching competitions" : "No competitions found"}
                  </TableCell>
                </TableRow>
              ) : (
                filteredCompetitions.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <StatusBadge status={item.is_participation_open ? "open" : "closed"} />
                    </TableCell>
